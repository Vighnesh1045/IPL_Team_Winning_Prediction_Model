...
```text
IPL_Team_Winning_Prediction_Model/
│
├── app.py                      # Streamlit interactive web application
├── ipl_model.py                # Data processing & model training script
...
```bash
git clone https://github.com/Vighnesh1045/IPL_Team_Winning_Prediction_Model.git
cd IPL_Team_Winning_Prediction_Model
...
3. **Verify Model File:**
Ensure `pipe.pkl` is located in the root directory (or run `python ipl_model.py` to regenerate the model file from your local datasets).
...
* **GitHub:** [github.com/Vighnesh1045](https://github.com/Vighnesh1045)
